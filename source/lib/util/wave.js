 ...
 * @param  {Number}   o      an optional offset (in milliseconds) at which to
 *                           start the wave
 *
 * @return {Function}        a wave function that takes a timestamp (optionally
 *                           offset by `o`) and returns a value between `min`
 *                           and `max` for the period `p`
 */
 ...
 *
 * @return {Function}        a wave function that takes a timestamp (optionally
 *                           offset by `o`) and returns an integer value between
 ...
 *                           (optionally offset by `o`) and returns a value
